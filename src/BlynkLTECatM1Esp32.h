/**
 * @file       BlynkLTECatM1Esp32.h
 * @author     Sori (Github: genesis0409)
 * @license    This project is released under the MIT License (MIT)
 * @copyright  Copyright (c) 2024 Sori (Github: genesis0409)
 * @date       Feb 2024
 * @brief
 *
 */

#ifndef BlynkLTECatM1Esp32
#define BlynkLTECatM1Esp32
